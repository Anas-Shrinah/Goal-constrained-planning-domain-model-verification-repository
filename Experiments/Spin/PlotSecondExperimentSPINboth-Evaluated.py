...
FilesNameConstrained = './SecondExperiment/Constrained/Results/BreadthFirst/Constrained-2-'
FilesNameUnconstrained = './SecondExperiment/Unconstrained/Results/BreadthFirst/Unconstrained-2-all.txt'
...
if __name__ == '__main__':
	...
	plt.grid(True)
	plt.savefig('SecondExperimentSPIN-EvaluatedStates-BreadthFirst.png')
	plt.show()
